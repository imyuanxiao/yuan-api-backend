...
public final class JwtManager {
     ...
     */
    private final static Integer EXPIRATION = 300;
    ...
    public static void verifyToken(String token) {
        ...
        try{
            //验证签名
            JWTUtil.verify(token, JWTSignerUtil.hs256(secretKeyBytes));
            // 验证算法
            JWTValidator.of(token).validateAlgorithm(JWTSignerUtil.hs256(secretKeyBytes));
        }catch (Exception e) {
